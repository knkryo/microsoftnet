...
namespace Common.ClassLibrary.Validation
{
	...
	/// </summary>
	/// <remarks></remarks>
	public class MinLengthBytesValidation : AbstructValidation
	{
		...
		/// <remarks></remarks>
		/// ------------------------------------------------------------------------------------------
		public MinLengthBytesValidation(string validationValue, int length) : this(validationValue, length, System.Text.Encoding.GetEncoding("Shift-JIS"))
		{
		}
		...
		public MinLengthBytesValidation(string validationValue, int Length, System.Text.Encoding encoding)
		{
