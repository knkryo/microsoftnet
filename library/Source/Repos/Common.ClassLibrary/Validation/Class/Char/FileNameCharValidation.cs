namespace Common.ClassLibrary.Validation
{
	...
	/// </summary>
	/// <remarks></remarks>
	public class FileNameCharValidation : AbstructValidation
	{
		...
		public FileNameCharValidation(string validationValue)
		{
		...
		public override bool IsValid()
		{
			...
			if (!this._ValidationValue.IndexOfAny(System.IO.Path.GetInvalidFileNameChars()).Equals(0)) {
